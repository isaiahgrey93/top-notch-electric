...
export default function ContactSection() {
  ...
  const { mutate, isLoading } = api.contact.submit.useMutation({
    onSuccess: () => {
      setSuccess(true);
    },
  });
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 px-6 lg:grid-cols-2 lg:px-8">
        ...
        >
          {!success ? (
            ...
            >
              <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                ...
                <div className="mt-8 flex justify-end">
                  <button
                    type="submit"
                    className="rounded-md bg-primary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
                    Send message
                  </button>
                </div>
            ...
            <div className="ml-3 mt-8 rounded-xl border-2 border-primary bg-white p-4">
              <p className="w-full text-center text-lg font-bold text-gray-700">
